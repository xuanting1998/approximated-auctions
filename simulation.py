...
def generate_data(auction_params, \
    ...
    return generate_data_with_param_vals(('quota_factor', 'num_bidders', 'cap_var'), params, sims_per_test, auction_params)
...
cap_var_data = generate_data_varied_by_cap_var(auction_params, min_cap_var=0.5, max_cap_var=6, num_tests=50, sims_per_test=100)
